        ...
        <div className="bg-white shadow-lg hover:shadow-xl rounded-lg">
          ...
          <div className="flex justify-between items-start px-2 pt-2">
            <div className="p-2 flex-grow">
              <h1 className="font-medium text-xl font-poppins">{item.name}</h1>
              <p className="text-gray-500 font-nunito">{item.description}</p>
            </div>
            <div className="p-2 text-right">
              <div className="text-teal-500 font-semibold text-lg font-poppins">{formatCurrency(item.priceCents / 100)}</div>
              {item.discountedPriceCents && (
                <div className="text-xs text-gray-500 line-through font-poppins">
                  {formatCurrency(item.discountedPriceCents / 100)}
                </div>
              )}
            </div>
          </div>
          <div className="flex justify-center items-center px-2 pb-2">
            <div className="w-1/2 p-2">
              <button className="block w-full bg-teal-500 hover:bg-teal-600 text-black border-2 border-teal-500 hover:border-teal-600 px-3 py-2 rounded uppercase font-poppins font-medium">
